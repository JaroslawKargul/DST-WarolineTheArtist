...
local SmallbirdDrawingBrain_Boat = Class(Brain, function(self, inst)
    Brain._ctor(self, inst)
	self.name = "smallbirddrawingbrain_boat"
end)

function SmallbirdDrawingBrain_Boat:OnStart()
...
return SmallbirdDrawingBrain_Boat
