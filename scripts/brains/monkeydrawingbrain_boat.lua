...
local MonkeyDrawingBrain_Boat = Class(Brain, function(self, inst)
    Brain._ctor(self, inst)
	self.name = "monkeydrawingbrain_boat"
end)

function MonkeyDrawingBrain_Boat:OnStart()
...
return MonkeyDrawingBrain_Boat
