...
local BeefaloDrawingBrain_Boat = Class(Brain, function(self, inst)
    Brain._ctor(self, inst)
	self.name = "beefalodrawingbrain_boat"
end)

function BeefaloDrawingBrain_Boat:OnStart()
...
return BeefaloDrawingBrain_Boat
